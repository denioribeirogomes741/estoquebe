...
import { X, Plus, Package, DollarSign, Tag, Image, FileText, Check, Star, Save } from 'lucide-react';
...
export default function EditModal({ item, onClose, onSave }: EditModalProps) {
  const [formData, setFormData] = useState({
    ...
    nivelQualidade: (item.nivelQualidade || 3) as 1 | 2 | 3 | 4 | 5,
    tagsEspecificas: item.tagsEspecificas || [] as string[]
  });
      ...
      <div className="position-relative">
        ...
        <div style={{ 
          ...
          <div className="d-flex justify-content-between align-items-center text-white">
            <div className="d-flex align-items-center gap-2">
              <Save size={24} />
              <h5 className="mb-0 fw-bold">Editar Item</h5>
            </div>
            <Button 
              variant="link" 
              onClick={onClose}
        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body className="p-4">
            {/* Info Card - Código e Categoria (não editáveis) */}
              ...
              <Row className="g-3">
                <Col md={6}>
                  ...
                  <div className="p-2 rounded bg-white border">
                    <span className="font-monospace fw-bold text-secondary">{item.codigo}</span>
                  </div>
                </Col>
                <Col md={6}>
                  <Form.Label className="fw-semibold small text-secondary d-flex align-items-center gap-2 mb-2">
                  ...
                  <div className="p-2 rounded bg-white border d-flex align-items-center gap-2">
                    <div 
                    ...
                    <span className="small text-secondary">{item.categoriaNome}</span>
                  </div>
                </Col>
              </Row>
            </div>
                ...
                <Form.Group>
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <Button
                      ...
                      onClick={() => setFormData({...formData, quantidade: Math.max(0, formData.quantidade - 1)})}
